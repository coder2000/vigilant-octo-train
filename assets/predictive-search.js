/**
 * Predictive Search functionality for Dead Inside Depot
...
class PredictiveSearch extends HTMLElement {
  ...
  onFocus() {
    ...
    if (this.searchTerm !== currentSearchTerm) {
      // Search term changed while input was not focused
      this.onChange();
    } else {
      this.open();
    }
  ...
  switchOption(direction) {
    ...
    const allVisibleElements = Array.from(this.querySelectorAll('li')).filter(
